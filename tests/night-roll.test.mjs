...
test("help sheet covers every shipped feature (drift guard — extend this list when you ship)", () => {
  ...
  const FEATURES = [
    ...
    "Import…", "NSF", "Commit import", "color picker", "sampled", "Rename…", "Chip audio", "Data locations", "Settings…", "Create album", "⚠", ".m3u", "duplicates in place", "Pencil drag", "cycles", "＋ drums", "?song=", "Drum fill", "Delete track", "Insert chord", "organized by emotion", "splits at that exact spot", "merge into one note", "helptabs", 'data-hsec="editor"', "HELP.md",
  ];
