...
**📻 Listener mode**
Phones open as a PLAYER: the roll, ⏮ ▶, the readouts, speed and volume — everything else hidden, because a shared song link is for listening, not editing. A **Full app** button in the header brings the whole DAW back on that device (and View ▾ → Listener mode folds it away again, on any device). Send someone a ?song= link and their phone just… plays it.
