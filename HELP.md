...
**Share a song**
The address bar is always a shareable link to the open song. The tab title and the link preview in Messages name the song first — "Threnody · Night Roll" — so a pasted link reads as the song, not the app.
